...
$url        = 'https://codeworkweb.com/demo-importer/smart-portfolio-demos/';
...
if( class_exists('CWW_Portfolio_Pro')){
    ...
    $data = array(
        ...
        'main' => array(
            ...
            'preview_url'       => 'https://demo.codeworkweb.com/cww-portfolio/smart-portfolio/',
    ...
    'premium' => array(
        ...
        'xml_file'          => $pro_url.'/demo-five/content.xml',
        'theme_settings'    => $pro_url.'/demo-five/customizer.dat',
        'home_title'        => 'Home',
        'blog_title'        => 'Blogs',
        'posts_to_show'     => '6',
        'is_shop'           => false,
        ...
        'required_plugins'  => array(
            ...
            'premium' => array(
                array(
                    'slug'    => 'sticky-floating-forms',
                    'init'    => 'sticky-floating-forms/sticky-floating-forms.php',
                    'name'    => 'Sticky Floating Forms Pro',
                    'link'    => '1.envato.market/Ygo9zm'
                ),
                array(
                    'slug'    => 'bizz-elements',
